...
import { useState, useRef, FC, ChangeEvent, MutableRefObject, ReactElement } from 'react'
...
const AudioPlayer: FC<IAudioPlayerProps> = ({ audioSrc }: IAudioPlayerProps): ReactElement => {
	const [isPlaying, setIsPlaying] = useState<boolean>(false)
	const [volume, setVolume] = useState<number>(0.5)
	const [volumeClass, setVolumeClass] = useState<'mute' | 'low' | 'medium' | 'high'>('medium')
	...
	const handleVolumeChange: (e: ChangeEvent<HTMLInputElement>) => void = (e: ChangeEvent<HTMLInputElement>): void => {
	...
	const handleSeek: (e: ChangeEvent<HTMLInputElement>) => void = (e: ChangeEvent<HTMLInputElement>): void => {
						...
						<div className='AudioPlayer__volumeContainer'>
							<div className='AudioPlayer__volumeContainer'>
								...
								<div className={`volume-icon-container ${volumeClass}`}>
									<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 64 64' className='volume-icon'>
										{/* Haut-parleur principal */}
										<path d='M10 24h12l14-14v44l-14-14H10z' fill='#36395a' />

										{/* Arc de volume faible */}
										<g className='volume-low'>
											<path d='M38 38c4-4 4-8 0-12' fill='none' stroke='#36395a' strokeWidth='4' />
										</g>

										{/* Arc de volume moyen */}
										<g className='volume-medium'>
											<path d='M42 43c6-6 6-16 0-22' fill='none' stroke='#36395a' strokeWidth='4' />
										</g>

										{/* Arc de volume élevé */}
										<g className='volume-high'>
											<path d='M46 48c8-8 8-24 0-32' fill='none' stroke='#36395a' strokeWidth='4' />
										</g>

										{/* Cross for mute */}
										<g className='mute-icon'>
											<line x1='40' y1='24' x2='56' y2='40' stroke='#36395a' strokeWidth='4' />
											<line x1='40' y1='40' x2='56' y2='24' stroke='#36395a' strokeWidth='4' />
										</g>
									</svg>
								</div>
