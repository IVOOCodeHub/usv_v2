  ...
  const menuData: IMenuContainerProps[] = [
    {
      ...
      items: [
        {
          name: "Courrier",
          link: "/commandes/tresorerie/courrier_depenses",
          isMigrated: true,
        },
        {
          name: "Nouvelle prévision de dépenses",
          link: "/commandes/tresorerie/nouvelle_prevision_depenses",
          isMigrated: true,
        },
        { name: "Prévisions à valider", link: "/" },
        { name: "Facturation Interco à régulariser", link: "/" },
        {
          name: "Prévisions à ordonnancer",
          link: "/commandes/tresorerie/prevision_a_ordonnancer",
          isMigrated: true,
        },
    ...
    },
    {
      ...
      items: [
        { name: "Courrier", link: "/" },
        {
          name: "Nouvelle prévision de recette EXTERNE",
          link: "/commandes/tresorerie/nouvelle_prevision_recette",
          isMigrated: true,
        },
