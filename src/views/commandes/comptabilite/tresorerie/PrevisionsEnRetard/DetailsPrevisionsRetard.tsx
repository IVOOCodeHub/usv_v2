...
const DetailsPrevisionsRetard: React.FC = () => {
	...
	return (
		<>
			<Header props={{ pageURL: `GIVOO | TRÉSORERIE | DÉTAILS PRÉVISION EN RETARD ${details.cle}` }} />
...
export default DetailsPrevisionsRetard
