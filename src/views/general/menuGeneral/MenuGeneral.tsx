  ...
  const menuData: IMenuContainerProps[] = [
    {
      title: "Paramétrages",
      items: [
        { name: "Organisation générale", link: "/menu_general" },
    ...
    {
      title: "Incidents",
      items: [{ name: "Gestion des incidents", link: "/menu_general" }],
    },
    {
      title: "Dossiers",
      items: [{ name: "Gestion des dossiers", link: "/menu_general" }],
    },
    {
      title: "Tâches",
    ...
    },
    {
      title: "Commandes",
      items: [
        { name: "Gestion des courriers", link: "/menu_general" },
        { name: "Commandes Fournisseurs", link: "/menu_general" },
        { name: "Associer un document", link: "/menu_general" },
        { name: "Recherche", link: "/menu_general" },
        { name: "Emissions", link: "/menu_general" },
        { name: "Retours", link: "/menu_general" },
        { name: "Gestion DOC clients", link: "/menu_general" },
        { name: "Annulation commande", link: "/menu_general" },
        { name: "Renvoi d'une commande au partenaire", link: "/menu_general" },
        { name: "Imp. courriers", link: "/menu_general" },
        { name: "Réception règlement", link: "/menu_general" },
        { name: "Gestion Commandes & Factures", link: "/menu_general" },
        { name: "Comptabilité", link: "/menu_general" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Validation des primes", link: "/menu_general" },
        { name: "Préparation des paies", link: "/menu_general" },
    ...
    },
    {
      title: "Appels",
      items: [
        { name: "Préparation de période", link: "/menu_general" },
        { name: "Gestion DON", link: "/menu_general" },
        { name: "Injections de vierges", link: "/menu_general" },
        { name: "Évaluations", link: "/menu_general" },
        { name: "Demande rappels forcés", link: "/menu_general" },
        { name: "Demande rappels forcés NA", link: "/menu_general" },
      ],
    },
    {
      title: "Statistique",
      items: [
        ...
        { name: "Progression plan d'appel", link: "/menu_general" },
        { name: "Imp. Affichage", link: "/menu_general" },
        { name: "Administration des ventes", link: "/menu_general" },
        { name: "Contrôle trésorerie", link: "/menu_general" },
      ],
    },
  ];
